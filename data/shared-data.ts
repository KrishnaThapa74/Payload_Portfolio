...
export const socialLinks = [
  ...
  { name: "GitHub", href: "https://github.com/KrishnaThapa74" },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/krishna-thapa-2419521b7/",
  },
  { name: "Instagram", href: "https://instagram.com/krishnathapa10" }, // Placeholder handle based on email
];

// Footer
export const footerData = {
  copyrightName: "Krishna Thapa",
  navLinks: [
...
export const sharedProjects = [
  ...
  },
  {
    ...
    client: "Personal Project",
    description:
      "A high-performance Hono REST API managing all business logic. Implements Service-Repository pattern, background workers, and granular RBAC. Integrates Gemini AI and Meilisearch.",
    tech: [
      "Hono",
      "TypeScript",
      "Redis",
  ...
  },
  {
    ...
    title: "Naamii",
    description:
      "A corporate research and innovation initiative focused on AI and computing.",
  ...
  },
  {
    ...
    title: "Kitsune App",
    description:
      "A mobile application for streaming anime, serving as a companion to the web platform.",
  ...
  },
  {
    ...
    title: "Workflow",
    description:
      "A project management tool and Jira clone enabling task tracking and team collaboration.",
    tech: ["Next.js", "React", "Tailwind CSS"],
    year: "2024",
  ...
  },
  {
    ...
    description:
      "The robust backend server powering the Kitsune anime streaming platform.",
...

  {
    ...
    description:
      "Final Year Project: A smart travel planner utilizing Gemini Vision for landmark recognition and i18n for multi-language support.",
